...
Computed under walk-forward cross-validation on data through **2026-05-13** (regenerated by `scripts/05_robustness.py`; numbers update with each data refresh):

| Specification | Features | OOS ROC-AUC | PR-AUC | Brier |
|---|---:|---:|---:|---:|
| VIX-level baseline | 1 | 0.473 | 0.334 | 0.289 |
| Volatility-only | 3 | 0.526 | 0.370 | 0.241 |
| Liquidity-only | 4 | 0.542 | 0.355 | 0.246 |
| **Full model** | **9** | **0.675** | **0.519** | **0.229** |
| Full − liquidity | 5 | 0.672 | 0.518 | 0.226 |
